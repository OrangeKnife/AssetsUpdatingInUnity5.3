...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
        ...
        static public void InitializeWithManifest(AssetBundleManifest assetBundleManifestObject, string[] availableVariants )
        {
#if UNITY_EDITOR
            ...
            m_AssetBundleManifest = assetBundleManifestObject;
            ActiveVariants = availableVariants;
            Initialized = true;
        }

		static private AssetBundleLoadManifestOperation Initialize (string manifestAssetBundleName)
		{
	#if UNITY_EDITOR
			Log (LogType.Info, "Simulation Mode: " + (SimulateAssetBundleInEditor ? "Enabled" : "Disabled"));
	#endif
